...
:experimental:
:url-github: https://github.com/hyperpolymath/obli-transpiler-framework
:url-gitlab: https://gitlab.com/hyperpolymath/obli-transpiler-framework
:url-bitbucket: https://bitbucket.org/hyperpolymath/obli-transpiler-framework
:url-codeberg: https://codeberg.org/hyperpolymath/obli-transpiler-framework
...
obli-transpiler-framework is part of the link:https://rhodium.sh[Rhodium Standard] (RSR) ecosystem.
